package com.example.notesapp.ui.customviews
...
import com.example.notesapp.common.getColorRes
...
class ColorPickerView : LinearLayout {
    ...
    var onColorClickListener: (color: Note.Colors) -> Unit = { }
